...
export const LoadingScreen = ({ show }) => {
    ...
    return (
        <div id="loadre-screen" className={
            `fixed top-0 left-0 h-screen w-screen p-5 pointer-events-none
            bg-stone-900 flex justify-center items-center z-50
            ${visible ? 'opacity-100' : 'opacity-0'} transition-all`
        }>
            <div className="flex flex-col items-center  text-center">

                <div className=" animate-spin loader ease-linear rounded-full border-8 border-t-8 h-28 w-28 border-gray-600 border-t-sky-600"></div>
